@@ -0,0 +1,88 @@
﻿<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Property Registration.aspx.vb" Inherits="Home" title="Untitled Page" %>
...
<%-- Add content controls here --%><asp:Content ID="Content1" runat="server" 
    ...
    style="top: 316px; left: 376px; position: absolute; height: 21px; width: 414px">
                        Property Registration will be available soon...<span class="style33"> </span></p>
                    <p class="style37" 
