@@ -0,0 +1,245 @@
﻿<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Landlord Registration.aspx.vb" Inherits="Inspection" title="Untitled Page" %>
...
<%-- Add content controls here --%><asp:Content ID="Content1" runat="server" 
    contentplaceholderid="ContentPlaceHolder1">
                    ...
                    <div style="top: 336px; left: 453px; position: absolute; height: 475px; width: 508px">
...
&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p style="text-align: center">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorOwnerID" runat="server" 
                                ControlToValidate="TextBoxOwnerID" ErrorMessage="Owner ID required i.e.100/ABC" 
                        ...
                        <asp:Label ID="LabelOwnerID" runat="server" 
                            style="top: 17px; left: 40px; position: absolute; height: 19px; width: 67px" 
                            Text="Owner ID:"></asp:Label>
                        <br />
                        <br />
                        ...
                        <p style="text-align: center">
                            ...
                            <asp:TextBox ID="TextBoxOwnerID" runat="server" 
                        ...
                        <asp:Button ID="ButtonReg" runat="server" 
                            style="top: 441px; left: 62px; position: absolute; height: 26px; width: 208px" 
                            Text="Register" />
                    </div>
                    <p>
                        &nbsp;</p>
                    <p>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                           ...
                           InsertCommand="INSERT INTO [Owner] ([OwnerID], [FirstName], [Surname], [Address], [ZipCode], [ContactTelephone], [ContactEmail], [DOB], [RegistrationDate]) VALUES (@OwnerID, @FirstName, @Surname, @Address, @ZipCode, @ContactTelephone, @ContactEmail, @DOB, @RegistrationDate)" 
                            SelectCommand="SELECT * FROM [Owner]"
                            >
                           
                        <InsertParameters>
                                <asp:ControlParameter ControlID="TextBoxOwnerID" PropertyName="Text" Name="OwnerID" Type="String" />
